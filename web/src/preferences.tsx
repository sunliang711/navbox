...
const zh = {
  ...
  siteMoreActions: '更多操作',
  copyCurrentURL: '复制当前 URL',
  copyDefaultURL: '复制默认 URL',
  ...
  adminQuickMenu: '快捷设置',
  more: '更多',
  adminSearch: 'admin 搜索',
  adminSearchPlaceholder: '搜索标题、URL、Tag',
  allTags: '全部 Tag',
  allSitesFilter: '全部网站',
  favoritesOnly: '仅常用',
  batchMode: '批量选择',
  ...
  exportScope: '导出范围',
  exportScopeAll: '全部数据',
  exportScopeSites: '选择网站',
  exportScopeTags: '选择 Tag',
  siteSelection: '网站选择',
  tagSelection: 'Tag 选择',
  ...
  siteActions: '网站操作',
  tagActions: 'Tag 操作',
  selectedTagsCount: '已选 Tag {{count}} 个',
  chooseBatchTags: '请选择要批量处理的 Tag',
  selectBatchTags: '选择 Tag',
  batchTagSheetTitle: '批量选择 Tag',
  moveUp: '上移',
  moveDown: '下移',
  close: '关闭',
  title: '标题',
...
const en: Record<TranslationKey, string> = {
  ...
  siteMoreActions: 'More actions',
  copyCurrentURL: 'Copy current URL',
  copyDefaultURL: 'Copy default URL',
  ...
  adminQuickMenu: 'Quick settings',
  more: 'More',
  adminSearch: 'admin search',
  adminSearchPlaceholder: 'Search title, URL, tag',
  allTags: 'All tags',
  allSitesFilter: 'All sites',
  favoritesOnly: 'Favorites only',
  batchMode: 'Batch select',
  done: 'Done',
  sortMode: 'Sort mode',
  ...
  exportScopeSites: 'Select sites',
  exportScopeTags: 'Select tags',
  ...
  chooseBatchTags: 'Choose tags for batch changes',
  selectBatchTags: 'Select tags',
  batchTagSheetTitle: 'Batch select tags',
  moveUp: 'Move up',
  moveDown: 'Move down',
  close: 'Close',
  title: 'Title',
